  ...
  return (
    <section id="home">
      ...
      <div className="sm:pt-28 pt-4">
        <div className="flex flex-col sm:flex-row max-h-auto max-w-[90%] mx-auto bg-gray-100/10 backdrop-blur-md border border-gray-100/30 shadow-md rounded-lg sm:py-10">
          {/* Text Section */}
          <div className="flex flex-col items-start justify-center py-10 px-6 sm:w-1/2">
            {/* Title */}
            <h1 className="text-md sm:text-xl font-semibold text-gray-100 mb-4">
              Welcome to
            </h1>

            {/* Main Heading */}
            <h1 className="text-lg sm:text-4xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-500 to-purple-500 leading-tight">
            ...
            <SplitText
              ...
              className="text-md font-semibold text-gray-100 mt-6 leading-relaxed max-w-lg sm:text-2xl"
              delay={200}
              duration={0.6}
              ease="power3.out"
              splitType="words"
          ...
          <div className="flex items-center justify-center sm:w-1/2 p-6">
            <model-viewer
              ...
              autoplay
              // camera-controls
               className="w-full h-55 sm:h-120 md:h-100" // adjust for small and large screens
            ></model-viewer>
          </div>
        </div>
