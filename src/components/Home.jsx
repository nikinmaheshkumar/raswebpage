...
function Home() {
  ...
  useEffect(() => {
      ...
      if (ref.current) {
        gsap.fromTo(
          ...
          },
          {
            ...
            scrollTrigger: {
              trigger: ref.current,
              start: "top 75%", // when section reaches 75% from top
              end: "top 25%", // until it's 25% from top
    ...
    gsap.to("#home", {
      backgroundPositionY: "-50%", // moves background upward while scroll
      ease: "none",
      scrollTrigger: {
        trigger: "#home",
        start: "top bottom",
        ...
        <div ref={heroRef} className="flex flex-col lg:flex-row max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-8 lg:py-16">
          ...
          <div className="flex flex-col justify-center lg:w-1/2 space-y-8 lg:pr-12">
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-6 justify-center items-center">
              <button
                onClick={() =>
                    (window.location.href = "https://www.instagram.com/ieeerasvit?igsh=MTI4NXdscWt4dmQ3ZQ==")
                }
              ...
              <button
                onClick={() =>
                    (window.location.href = "https://www.linkedin.com/company/ieee-ras-vit/")
                }
              ...
              <button
                onClick={() =>
                    (window.location.href = "https://medium.com/@ieeeras")
                }
